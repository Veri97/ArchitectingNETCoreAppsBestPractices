...
namespace GloboTicket.TicketManagement.Application.UnitTests.Mocks
{
    public class RepositoryMocks
    {
        ...
        public static Mock<ICategoryRepository> GetCategoriesListWithEvents()
        {
            var concertGuid = Guid.Parse("{B0788D2F-8003-43C1-92A4-EDC76A7C5DDE}");
            var musicalGuid = Guid.Parse("{6313179F-7837-473A-A4D5-A5571B43E6A6}");
            var playGuid = Guid.Parse("{BF3F3002-7E53-441E-8B76-F6280BE284AA}");
            ...
            var concertEventList = new List<Event>
            {
             new Event
             {
            ...
            var conferenceEventList = new List<Event>
            {
            new Event
            {
            ...
            var musicalEventList = new List<Event>
            {
            new Event
            {
            ...
            var categories = new List<Category>
            {
                new Category
                {
                    CategoryId = concertGuid,
                    Name = "Concerts",
                    Events = concertEventList
                },
                new Category
                {
                    CategoryId = musicalGuid,
                    Name = "Musicals",
                    Events = musicalEventList
                },
                new Category
                {
                    CategoryId = conferenceGuid,
            ...
            mockCategoryRepository.Setup(x => x.GetCategoriesWithEvents(false)).ReturnsAsync(categories);
